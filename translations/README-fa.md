...
## عبارات منظم (Regular Expressions) چیست؟
</div>
...
> عبارات منظم یک گروه از کارکترها یا نمادها هستند که برای پیدا کردن یک الگوی مشخص در یک متن به کار گرفته می شود.
</div>

<div dir="rtl">
یک عبارت منظم یک الگو است که با یک رشته و یا رشته هایی خاص مطابقت دارد. عبارت منظم در اعتبار سنجی داده های ورودی فرم ها، پیدا کردن یک زیر متن در یک متن بزرگتر و مواردی از این دست به کار گرفته می شود. معمولا بجای عبارت "Regular expression" از مخفف آن یعنی "regex" یا "regexp" استفاده می شود.

فرض کنید یه برنامه نوشته اید و می خواهید قوانینی برای گزینش نام کاربری برا کاربران بگذارید.  می خواهید اجازه دهید که نام کاربری شامل حروف، اعداد، خط زیر (Underline) و فاصله باشد. همچنین می خواهیم تعداد مشخصه ها (کارکترها) را در نام کاربری محدود کنیم . ما از چنین عباراتی برای اعتبار سنجی نام کاربری استفاده می کنیم:
</div>
<br/><br/>
<p align="center">
...
- [همخوانی های پایه ای](#1-basic-matchers)
...
یک عبارت منظم برای جست و جو در یک متن است. برای مثال عبارت منظم  `the` به معنی : حرف
...
[این عبارت منظم را در عمل ببینید](https://regex101.com/r/dmRygT/1)
